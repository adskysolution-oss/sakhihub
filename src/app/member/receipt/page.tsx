...
export default function MemberReceiptLandingPage() {
  ...
  if (!membership) {
    return (
      <DashboardLayout>
        <div className="max-w-2xl mx-auto mt-10 p-10 bg-white rounded-[35px] border border-gray-100 shadow-soft text-center">
          <div className="w-16 h-16 bg-primary/5 rounded-full flex items-center justify-center text-primary mx-auto mb-6">
            <Clock size={32} className="animate-pulse" />
          </div>
          <h2 className="text-2xl font-black text-secondary">No Active Receipt Found</h2>
          <p className="text-gray-500 font-medium leading-relaxed mt-3 max-w-md mx-auto">
            It looks like your membership payment is not completed or verified yet. Complete your onboarding payment to download and print your official membership slip.
          </p>
          <button 
            onClick={() => router.push('/member/dashboard')}
            className="mt-8 btn-primary px-8 py-3.5 text-xs font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-md cursor-pointer"
          >
