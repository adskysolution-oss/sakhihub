  ...
  try {
    ...
    if (purpose === 'Registration') {
      ...
      const userData: any = {
        ...
        workState: pendingUser.workState,
        workDistrict: pendingUser.workDistrict,
        workBlock: pendingUser.workBlock,
        workTehsil: pendingUser.workTehsil,
        workPincode: pendingUser.workPincode,
        workArea: pendingUser.workArea,
        workAddress: pendingUser.workAddress,
        aadhaarNumber: pendingUser.aadhaarNumber,
        status: userRole === 'employee' ? 'pending' : userRole === 'staff' ? 'documents_pending' : userStatus,
        isVerified: userRole === 'super_admin' ? true : false,
        assignmentStatus: (userRole === 'super_admin' || userRole === 'vendor' || userRole === 'staff') ? 'completed' : (pendingUser.parentVendorId ? 'completed' : 'pending'),
