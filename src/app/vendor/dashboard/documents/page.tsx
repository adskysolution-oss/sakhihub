...
import { 
  FileText, ShieldCheck, Download, AlertCircle, CheckCircle, ChevronRight, Upload
} from "lucide-react";
                    ...
                    {hasUploaded ? (
                      <div className="flex flex-col gap-3 bg-white/70 p-3 rounded-2xl border border-gray-100">
                        ...
                        <div className="flex items-center justify-between gap-3 pt-2 border-t border-gray-100">
                          <a href={authLetter.uploadedDocumentUrl} target="_blank" rel="noopener noreferrer" className="text-[10px] font-black text-primary uppercase tracking-widest hover:underline flex items-center gap-2">
