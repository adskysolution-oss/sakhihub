...
export interface ICommissionConfig extends Document {
  ...
  membershipOfflinePaymentEnabled: boolean; // true/false
...
const CommissionConfigSchema: Schema = new Schema(
  {
    ...
    membershipOfflinePaymentEnabled: { type: Boolean, default: true },
...
if (mongoose.models.CommissionConfig) {
  delete mongoose.models.CommissionConfig;
}

export default mongoose.model<ICommissionConfig>('CommissionConfig', CommissionConfigSchema);
