...
export default function CampaignManagementContent() {
  const { user: currentUser } = useAuth();
  const canViewVendors = currentUser?.role === 'super_admin' || 
    (Array.isArray(currentUser?.permissions) && currentUser.permissions.includes('vendors.view'));
