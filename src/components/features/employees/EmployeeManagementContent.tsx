              ...
              >
                ...
                <div className="bg-secondary-dark p-10 text-white relative shrink-0">
                  ...
                  <div className="flex gap-2 mt-8 bg-white/5 p-1.5 rounded-[24px] border border-white/10 w-fit">
                    ...
                    {(hasOfferLetterView || hasOfferLetterGenerate) && (
                      <button
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <p className="font-mono font-bold text-secondary text-sm mt-1 truncate">
                                {selectedEmp.aadhaarNumber ? (
                                  canViewCredentials 
                                    ? selectedEmp.aadhaarNumber.replace(/(\d{4})/g, '$1 ').trim() 
                                    : `•••• •••• ${selectedEmp.aadhaarNumber.slice(-4)}`
                                ) : 'Not Provided'}
                              </p>
                            </div>
                          </div>
                          ...
                          {selectedEmp.bankDetails?.accountNumber ? (
                            <div className="grid grid-cols-2 gap-4 text-xs">
                              <div className="min-w-0">
                                ...
                                <p className="font-bold text-secondary truncate mt-0.5">
                                  {canViewCredentials ? (selectedEmp.bankDetails?.accountHolderName || 'N/A') : '••••••••'}
                                </p>
                              </div>
                              <div className="min-w-0">
                                <p className="text-[8px] font-black text-gray-400 uppercase">Account Number</p>
                                <p className="font-mono font-bold text-secondary truncate mt-0.5">
                                  {canViewCredentials 
                                    ? selectedEmp.bankDetails?.accountNumber 
                              ...
                              <div className="min-w-0">
                                ...
                                <p className="font-mono font-bold text-secondary truncate mt-0.5">
                                  {canViewCredentials ? (selectedEmp.bankDetails?.ifscCode || 'N/A') : '••••••••'}
                                </p>
                              </div>
                              <div className="min-w-0">
                                <p className="text-[8px] font-black text-gray-400 uppercase">Branch</p>
                                <p className="font-bold text-secondary truncate mt-0.5">
                                  {canViewCredentials ? (selectedEmp.bankDetails?.branchName || 'N/A') : '••••••••'}
                                </p>
                              </div>
                            </div>
                          ) : (
